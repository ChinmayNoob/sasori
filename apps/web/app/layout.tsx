      ...
      <body className="text-sand-900 font-sans min-h-screen flex flex-col overflow-x-hidden selection:bg-stone-200 selection:text-black animated-bg antialiased">
        <div className="layout-container flex h-full grow flex-col relative w-full">
          ...
          <div className="fixed inset-0 pointer-events-none z-[-1] overflow-hidden">
            <div className="absolute top-[-20%] left-[-10%] w-[70vw] h-[70vw] bg-linear-to-br from-amber-50 to-transparent rounded-full blur-[120px] opacity-40 animate-float"></div>
            ...
            <div className="absolute bottom-[-20%] left-[10%] w-[50vw] h-[50vw] bg-amber-100/30 rounded-full blur-[100px] opacity-30"></div>
          </div>
